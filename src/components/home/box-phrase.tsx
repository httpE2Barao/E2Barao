export const BoxMainPhrase = ({language}: {language:string}) => {
  ...
  return (
    <h1 className="slideRight pt-[7vh] flex flex-col gap-10 justify-between textShadow-xl text-[1.77em] text-[#00000077] tracking-widest leading-normal font-extrabold uppercase sm:text-4xl xl:text-5xl 2k:text-4xl 2xl:text-5xl 4k:text-6xl w-full">
