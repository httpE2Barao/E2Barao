export const BoxMainPhrase = ({language}: {language:string}) => {
  ...
  return (
    <h1 className="slideRight px-3 mr-auto flex flex-col gap-10 justify-between text-5xl text-[#000000ca] font-bold md:text-6xl 2k:text-6xl 2xl:text-6xl 4k:text-7xl w-full">
