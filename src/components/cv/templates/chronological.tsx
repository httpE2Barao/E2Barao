...
const styles = StyleSheet.create({
  ...
  header: { marginBottom: 16, wrap: false },
  name: { fontSize: 22, fontWeight: 700, color: "#0f172a", marginBottom: 2, wrap: false },
  title: { fontSize: 11, color: "#64748b", marginBottom: 8, wrap: false },
  contactRow: { flexDirection: "row", flexWrap: "wrap", gap: 12, fontSize: 9, color: "#475569", wrap: false },
  ...
  entryHeader: { flexDirection: "row", justifyContent: "space-between", marginBottom: 2, wrap: false },
