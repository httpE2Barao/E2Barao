...
const styles = StyleSheet.create({
  ...
  sidebarSection: { marginBottom: 16, wrap: false },
  ...
  sidebarText: { fontSize: 8, color: "#cbd5e1", marginBottom: 3, lineHeight: 1.4, wrap: false },
  sidebarLink: { fontSize: 8, color: accentColor, marginBottom: 3, lineHeight: 1.4, wrap: false },
  sidebarSkill: { fontSize: 8, color: "#e2e8f0", marginBottom: 2, wrap: false },
  ...
  skillTag: { fontSize: 8, backgroundColor: "#fef3c7", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 3, color: "#92400e", wrap: false },
});
