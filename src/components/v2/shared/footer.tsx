...
export function V2Footer() {
  ...
  const desc = language === "pt" ? "Designer, Desenvolvedor & Desenvolvedor Full-Stack criando experiências digitais que marcam." : language === "es" ? "Diseñador, Desarrollador & Desarrollador Full-Stack creando experiencias digitales que marcan." : language === "fr" ? "Designer, Développeur & Développeur Full-Stack créant des expériences numériques marquantes." : language === "zh" ? "设计师、开发者和全栈开发者，打造令人难忘的数字体验。" : "Designer, Developer & Full-Stack Developer crafting digital experiences that leave a mark."
