export const listaExperiencias = [
  ...
  },
  {
    ...
    cardDetailedText: [
      ...
      {
        softSkills: 'Problem Solving, Critical Thinking, Teamwork, Communication.',
    ...
    cardDetailedText: [
      {
        ...
        description: [`Desenvolvi habilidades significativas no campo de argumentação e resolução de problemas.`, `Participei de projetos dinâmicos à distância.`, `Reforcei todo conhecimento adquirido nos ensinos fundamental e médio.`,]
      },
      {
        softSkills: 'Learning, Discipline, Organization.',
        hardSkills: 'Mathematical skills and logical reasoning, Humanities and Writing skills competence.',
        description: ['Developed significant skills in the field of argumentation and problem solving.', 'Participated in dynamic distance learning projects.', 'Reinforced all the knowledge acquired in elementary and middle school.']
      },
    ]
  },
  {
